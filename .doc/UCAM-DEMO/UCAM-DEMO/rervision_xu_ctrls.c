...
{	
	...
	*QP_Val = -1;
	...
	int err_chip;
	err_chip = XU_Ctrl_ReadChipID(fd);
	if (err_chip < 0) return err_chip;
...
{	
	...
	TestAp_Printf(TESTAP_DBG_FLOW, "      Get Support Resolution %d\n", Info->format);
